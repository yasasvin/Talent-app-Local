...
namespace Talent.Services.Listing.Controllers
{
    ...
    public class ListingController : Controller
    {
        ...
        {
            // Calls the 'GetTalentWatchlistIds' function of 'TalentService' which returns 'TalentWatchList' field of
            // supplied 'employerId'
            var talentWatchlistData =  await _talentService.GetTalentWatchlistIds(_userAppContext.CurrentUserId);
            return Json(new { Success = true, TalentWatchLists = talentWatchlistData });
            //throw new NotImplementedException();
        }
