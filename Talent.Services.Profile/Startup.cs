...
namespace Talent.Services.Profile
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            // My Code to enable directory browsing...Ref: https://docs.microsoft.com/en-us/aspnet/core/fundamentals/static-files?view=aspnetcore-2.2
            app.UseStaticFiles(); // For the wwwroot folder

            // By using the below code, you can access all the static files such as HTML, CSS, images, and JavaScript
            // A request to http://<server_address>/images/banner1.svg serves the 'banner1.svg' file
